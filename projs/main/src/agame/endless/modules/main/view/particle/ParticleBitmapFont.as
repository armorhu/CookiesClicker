...
package agame.endless.modules.main.view.particle
{
	 ...
	 *  font.  
	 */ 
	public class ParticleBitmapFont
	{
		...
		public function ParticleBitmapFont(texture:Texture=null, fontXml:XML=null)
		{
			// if no texture is passed in, we create the minimal, embedded font
			if (texture == null && fontXml == null)
			{
				texture = ParticleBitmapFontData.texture;
				fontXml = ParticleBitmapFontData.xml;
			}
		...
		public function fillQuadBatch(x:Number,y:Number,alpha:Number,r:Number,quadBatch:QuadBatch, width:Number, height:Number, text:String,
									  fontSize:Number=-1, color:uint=0xffffff, 
									  hAlign:String="center", vAlign:String="center",      
									  autoScale:Boolean=true, 
									  kerning:Boolean=true):void
		{
			...
			for (var i:int=0; i<numChars; ++i)
			{
				...
				mHelperImage.y = charLocation.y+y;
				mHelperImage.scaleX = mHelperImage.scaleY = charLocation.scale;
				mHelperImage.alpha=alpha;
				mHelperImage.rotation=r;
